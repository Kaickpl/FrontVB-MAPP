    ...
    <div className="container-principal">
      <header className="cabecalho-principal">
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            ...
            <h4 className="titulo-cabecalho">Meus Pacientes</h4>
        </div>
        <div className="etiqueta-destaque" style={{ backgroundColor: 'rgba(255,255,255,0.2)', color: 'white' }}>
           Usuário Logado
        </div>
      </header>
      ...
      <main className="conteudo-pagina">
        ...
        <div className="secao-apresentacao" style={{ marginBottom: '30px' }}>
            <h2 style={{ fontSize: '1.8rem', fontWeight: 'bold', color: '#1e293b' }}>
                Quem vamos avaliar hoje?
            </h2>
            <p style={{ color: '#64748b' }}>
                Selecione um paciente abaixo para iniciar ou continuar o protocolo VB-MAPP.
            </p>
        </div>
                    ...
                    >
                        <div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '15px' }}>
                                <div style={{ 
                                    width: '50px', height: '50px', backgroundColor: '#e0f2fe', 
                                ...
                                <div>
                                    ...
                                    <span style={{ fontSize: '0.85rem', color: '#64748b' }}>ID: {p.idPaciente}</span>
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', color: '#475569' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    ...
                                    <span style={{ fontSize: '0.9rem' }}>Responsável: <strong>{p.responsavel}</strong></span>
                                </div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <Calendar size={16} color="#3b82f6" />
                                    <span style={{ fontSize: '0.9rem' }}>Nascimento: {p.dataNascimento}</span>
                                </div>
                            </div>
                        </div>
